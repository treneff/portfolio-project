      ...
      content = (
        <div className={classes.ContainerText}>
          <div className={classes.TextHalfScreen}>
            <p>
              An ambitious and very hardworking front-end developer with background working as a
              Physiotherapist with high performance athletes.
            </p>
            <p>
              Currently focused on front-end development with JavaScript and ReactJS and the
      ...
      content = (
        <div className={classes.ContainerText}>
          ...
          <div className={classes.TextHalfScreen}>
            ...
            <p>
              Fascinated by different cultures and lucky enough to have lived and travelled around
              Belgium,France, Bulgaria and England.
            </p>
          </div>
        </div>
      );
